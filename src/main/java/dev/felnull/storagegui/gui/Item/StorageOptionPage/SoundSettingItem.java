...
public class SoundSettingItem extends GUIItem {
    ...
    public SoundSettingItem(InventoryGUI gui, @NotNull StorageSoundENUM storageSoundENUM, StorageData storageData, @NotNull StorageSoundData storageSoundData) {
        ...
        lore.add(Component.text("§b現在指定中のサウンド"));
