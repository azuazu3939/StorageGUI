...
public class GUIReload implements CommandExecutor {
    ...
    private static String PAGE_BACK, RETURN_MAIN, BUY_STORAGE, BUY_FAIL, SCROLL_POS;
    private static String SYMBOL;
    private static String ADD_VIEW_POS = StorageGUI.getInstance().getConfig().getString("messages.add-view-pos", "§r§aスロットPosを上げる");
    private static String SUB_VIEW_POS = StorageGUI.getInstance().getConfig().getString("messages.sub-view-pos", "§r§bスロットPosを下げる");
